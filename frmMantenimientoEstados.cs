...
namespace Proyecto
{
    public partial class frmMantenimientoEstados : Form
    {
       // Código del estado del usuario del sistema.Valor numérico y llave primaria en la tabla.
       //Descripción del Estado.Solamente debe de aceptar letras y espacios.
       //Los códigos donde 0 es inhabilitado y 1 habilitado.

       string archivo;
        string ruta = @"C:\Users\kimiv\Downloads\Proyecto\Proyecto\Archivos\";

        public frmMantenimientoEstados()
        {
            InitializeComponent();
        }
        ...
        public void leerArchivo()
        {
            ...
            try
            {
                ...
                string codEstadoUsuario, descripEstadoUsuario;
                ...
                while (leer.Peek() != -1) //.pkeek trae ultima l[inea
                {
                    ...
                    codEstadoUsuario = separador[0];
                    descripEstadoUsuario = separador[1];
                    ...
                    lstMantEstados.Items.Add(codEstadoUsuario);
                    // lstMantEstados.Items.Add[lsvMantServicios.Items.Count - 1].SubItems.Add(descripEstadoUsuario);
        ...
        {
            lstMantEstados.Clear();
            lstMantEstados.Columns.Add("CODIGO DE ESTADO DE LA RESERVA").Width = 100;
            lstMantEstados.Columns.Add("DESCRIPCION").Width = 100;
        }
        private void btnCrear_Click(object sender, EventArgs e)
        {
            ...
            //Variables
            archivo = "MantenimientoEstados.txt";
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (txtCódEstadoUsuario.Text.Equals("") || txtDescripciónPerfil.Text.Equals(""))
                    {
                        MessageBox.Show("Datos incompletos completos", "alerta", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        txtCódEstadoUsuario.Focus();
                    }
                    else
                    {
                        escribir.WriteLine(txtCódEstadoUsuario.Text + "," + txtDescripciónPerfil.Text + ",");
                        escribir.Close();
        ...
        private void btnInhabilitar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                while (leer.Peek() != -1) // vamos a hacer la lectura de la linea
                {
                    ...
                    if (separador[0] != txtCódEstadoUsuario.Text || separador[1] != txtDescripciónPerfil.Text)
                    {
        ...
        private void frmMantenimientoEstados_Load(object sender, EventArgs e)
        {
